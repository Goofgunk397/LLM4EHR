...
class EHRLongformerEncoder(nn.Module):
    """
    Using clinical longformer
    """
    def __init__(self, n_channel, max_steps=200, patch_size=5):
        super().__init__()
        self.base_model = AutoModel.from_pretrained("yikuan8/Clinical-Longformer")
...
class EHRLongformerModel(nn.Module):
    def __init__(self, n_channel, max_steps=200, patch_size=5):
        super().__init__()
        self.encoder = EHRLongformerEncoder(n_channel, max_steps, patch_size)
